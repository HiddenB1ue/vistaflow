...
async def get_train_stops(
    train_code: str,
    from_station: str = Query(..., min_length=1, description="起始站名"),
    to_station: str = Query(..., min_length=1, description="终到站名"),
    full_route: bool = Query(default=False, description="是否返回全程经停"),
